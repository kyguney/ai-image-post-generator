...
class ModuleInitialization {
	...
	/**
	 * Get all the AIPGPlugin plugin classes.
	 *
	 * @return array
	 */
	protected function get_classes() {
		$class_finder = new ClassFinder();
		$class_finder::setAppRoot( AIPG_PLUGIN_PATH );
		return $class_finder::getClassesInNamespace( 'AIPGPlugin', ClassFinder::RECURSIVE_MODE );
	}

	/**
	 * Initialize all the AIPGPlugin plugin classes.
	 *
	 * @return void
	 */
	public function init_classes() {
		...
		foreach ( $this->get_classes() as $class ) {
			...
			if ( ! $reflection_class->isSubclassOf( '\AIPGPlugin\Module' ) ) {
				continue;
			}
	 ...
	 *
	 * @return false|\AIPGPlugin\Module
	 */
